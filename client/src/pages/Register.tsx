      ...
      <div className="container mx-auto px-4 py-20 flex justify-center items-center min-h-[80vh]">
        <Card className="w-full max-w-md border-border/50 shadow-xl shadow-primary/5">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold text-primary font-display">Create Account</CardTitle>
            <CardDescription>Join PakLegal AI to start generating documents</CardDescription>
          </CardHeader>
          <CardContent>
